  ...
  <tr>
    ...
    <td>
        @if($user->is_active==1)
            ...
            <label class="badge badge-success" style="background-color: #3ac060">is Active</label>
        @else

            <label class="badge badge-success" style="background-color: red">not Active</label>
        @endif
