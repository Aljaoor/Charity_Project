                        ...
                        <div class="col-md-6">
                            <div class="volunteer-contact">
                                <div class="volunteer-contact-form">
                                    <form  action="{{route('event.update')}}" method="post" class="contact-validation-active" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group">
                                                <input type="text" class="form-control" name="title" id="title" value="{{$event->title}}" placeholder="ُEnter name or title...">
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group">
                                                <input type="date" class="form-control" name="from_date" value="{{$event->from_date}}" id="from_date">
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group clearfix">
                                                <input type="date" class="form-control" name="to_date" value="{{$event->to_date}}" id="to_date">
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group clearfix">
                                                <input type="text" class="form-control" name="count_of_volunteers" value="{{$event->count_of_volunteers}}" id="count_of_volunteers" placeholder="Number of volunteers">
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group">
                                                <input type="text" class="form-control" name="where" id="where" value="{{$event->where}}" placeholder="ُEnter the place...">
                                            </div>


                                            <div class="col-lg-12 col-12 form-group">
                                                <textarea class="form-control" name="describe" id="describe"  placeholder="Case Description...">{{$event->describe}}</textarea>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group">
                                                <input type="text" class="form-control" name="location" id="location" value="{{$event->location}}" placeholder="ُEnter the link of location...">
                                            </div>
                                            ...
                                            <div class="submit-area col-lg-12 col-12">
                                                <button type="submit" class="theme-btn submit-btn">Edit Event</button>
                                                <div id="loader">
                                                    <i class="ti-reload"></i>
                                                </div>
                                            </div>
