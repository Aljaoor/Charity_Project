                                ...
                                <table style="text-align: center;width:100%; border: 1px #2db85d solid;padding:0px; ">
                                    ...
                                    @foreach($status as $status)
                                        ...
                                        <tr style="padding:20px; width:200px;">
                                            ...
                                            @if(\App\Models\Beneficiary::whereMemberId(\auth()->user()->id)->whereOfficeId($status->office_id)->exists())

                                                <td style="padding:20px; width:150px">
                                               {{ \App\Models\Beneficiary::whereMemberId(\auth()->user()->id)->whereOfficeId($status->office_id)->first()->help}}
