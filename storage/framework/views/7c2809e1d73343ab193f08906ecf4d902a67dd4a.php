                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        ...
                        <div id="Donations" class="tab-pane">
                            <form action="<?php echo e(route('event.test')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                                    ...
                                                    <div id="open5" class="payment-name">
                                                        <ul>
                                                            <li class="visa"><input id="1" type="radio" name="size" value="30">
                                                                <label for="1"><img src="<?php echo e(asset('website/images/checkout/img-1.png')); ?>" alt=""></label>
                                                            </li>
                                                            <li class="mas"><input id="2" type="radio" name="size" value="30">
                                                                <label for="2"><img src="<?php echo e(asset('website/images/checkout/img-2.png')); ?>" alt=""></label>
                                                            </li>
                                                            <li class="ski"><input id="3" type="radio" name="size" value="30">
                                                                <label for="3"><img src="<?php echo e(asset('website/images/checkout/img-3.png')); ?>" alt=""></label>
                                                            </li>
                                                            <li class="pay"><input id="4" type="radio" name="size" value="30">
                                                                <label for="4"><img src="<?php echo e(asset('website/images/checkout/img-4.png')); ?>" alt=""></label>
                                                            </li>
                                                        </ul>
...
<?php echo $__env->make('website.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\charity\Charity_Project\resources\views/website/donate.blade.php ENDPATH**/ ?>