...
<div class="page-wrapper">
    ...
    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
                ...
                <?php $__currentLoopData = $volunteerrequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $volunteerrequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $i++; ?>
                    <tr id="eid<?php echo e($volunteerrequest->event_id); ?>">
                    ...
                    <?php endif; ?>
                     ...
                     <?php endif; ?>
                        ...
                        <td>
                            <input type="checkbox" name="ids"  class="checkBoxClass" value="<?php echo e($volunteerrequest->event_id); ?>" data-volunteer="<?php echo e($volunteerrequest->volunteer_id); ?>" style="margin-left: 20px; margin-top: 35px;">
                        </td>
    ...
    <form action="<?php echo e(route('eventsvolunteer.acceptcheck')); ?>" method="post">
        <?php echo csrf_field(); ?>
    ...
    <form action="<?php echo e(route('eventsvolunteer.denycheck')); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\charity\Charity_Project\resources\views/website/request/acceptingrequests.blade.php ENDPATH**/ ?>