                                ...
                                <div class="col-md-6">
                                    <div class="volunteer-contact" >
                                        <div class="volunteer-contact-form" style="background: black;">
                                            ...
                                            <form  action="<?php echo e(route('event.create')); ?>" method="post" class="contact-validation-active" enctype="multipart/form-data" >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group form-group-in">
                                                        ...
                                                        <input id="file" type="file"  class="<?php $__errorArgs = ['event_image'];
...
unset($__errorArgs, $__bag); ?> form-control" name="event_image" accept=".jpg, .png, image/jpeg, image/png">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group clearfix">
                                                        <input type="text" class="<?php $__errorArgs = ['count_of_volunteers'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> form-control"  name="count_of_volunteers" id="count_of_volunteers" placeholder="Number of volunteers">
...
unset($__errorArgs, $__bag); ?> form-control"  name="where" id="where" placeholder="ُEnter the place...">
...
<?php echo $__env->make('website.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\charity\Charity_Project\resources\views/website/event/add.blade.php ENDPATH**/ ?>